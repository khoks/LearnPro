...
- 2026-04-26 — done (PR #7). 4 policies + 21 unit tests + DI wired into apps/api + `/policies` smoke endpoint + LEARNPRO_POLICY_CONFIG env-driven config. EPIC-019 now fully done.
